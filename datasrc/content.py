...
image_rc_ascend_icon = Image("rcascendicon", "rclient/icons/ascendclient_size.png")
...
container.images.Add(image_rc_ascend_icon)
...
set_rc_weapons = SpriteSet("rcweapons", image_rc_weapons, 4, 1)
...
container.spritesets.Add(set_rc_weapons)
...
container.sprites.Add(Sprite("rc_weapons_shotgun", set_rc_weapons, 0, 0, 1, 1))
container.sprites.Add(Sprite("rc_weapons_grenade", set_rc_weapons, 1, 0, 1, 1))
container.sprites.Add(Sprite("rc_weapons_ninja", set_rc_weapons, 2, 0, 1, 1))
container.sprites.Add(Sprite("rc_weapons_laser", set_rc_weapons, 3, 0, 1, 1))
