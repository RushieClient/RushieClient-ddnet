...
// Translate
MACRO_CONFIG_STR(TcTranslateBackend, tc_translate_backend, 32, "bing", CFGFLAG_CLIENT | CFGFLAG_SAVE, "Translate backends (ftapi, libretranslate, googlegtx, fedilab, bing)")
